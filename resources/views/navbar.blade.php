<nav class="navbar navbar-expand-lg navbar-light shadow bg-info">
    ...
    <h2 class="p-2 text-black" style="font-size:23px; font-weight:400;"><b><i>Final Cheaptalk</i></b></h2>
    ...
    <div class="collapse navbar-collapse d-flex justify-content-center" id="navbarSupportedContent">
        <ul class="navbar-nav d-flex align-items-end justify-content-end">
            <li class="nav-item">
                <a class="nav-link text-black {{ 'dashboard' == request()->path() ? 'active' : '' }}"
                    href="{{ '/dashboard' }}">Dashboard</a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-black {{ 'recent-post' == request()->path() ? 'active' : '' }}"
            ...
            @role('admin')
                ...
                {{-- <li class="nav-item">
                    <a class="nav-link text-black {{ 'contact' == request()->path() ? 'active' : '' }}"
