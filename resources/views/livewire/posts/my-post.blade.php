<div class="div">
    ...
    <div class="container ">
        <div class="profile">
            <h2 class="mt-3 text-center" style="font-size: 23px; color:black;">{{Auth::user()->name}}'s Profile</h2>
        </div>
        <div class="post-body">
            <div class="col-md-12 offset-md-10" style="width: 200px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:white;background-color: black;" data-toggle="modal" data-target="#click">Create new post</button>
                </div>
            </div>
            ...
            <div class="col-md-3  offset-1">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    <div class="card-header">
                        @if($post->isEditable())
                        <span>
                            <span class="fa-solid fa-edit text-light" type="button"  aria-expanded="false"></span>
                            <ul>
                                <li><a class="btn-btn bg-danger text-white" data-toggle="modal" data-target="#click-delete" wire:click="delete({{ $post->id }})"><b>Delete</b></a></li>
                                <li><a class="btn-btn bg-warning text-dark" data-toggle="modal" data-target="#click-edit" wire:click="editPosts({{ $post->id }})"><b>Edit</b></a></li>
                            </ul>
                        </span>
                        @endif
                    ...
                    <div class="card-footer">
                        ...
                        src="{{ $post->user->gender === 'Female' ? asset('images/man.png') : asset('images/woman.png') }}" 
                        alt="photo">
